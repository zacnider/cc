function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("bg_preloader", "./sprites/bg_menu2.png");
    ...
    this.attachSprites = function () {
        ...
        oBg.regX = oBg.getBounds().width/2;
        oBg.regY = oBg.getBounds().height/2;
        var scaleX = CANVAS_WIDTH / oBg.getBounds().width;
        var scaleY = CANVAS_HEIGHT / oBg.getBounds().height;
        oBg.scaleX = scaleX; // X eksenini tam stretch et
        oBg.scaleY = scaleY; // Y eksenini tam stretch et
        _oContainer.addChild(oBg);

        var oSprite = s_oSpriteLibrary.getSprite('progress_bar');
        _oProgressBar = createBitmap(oSprite);
        _oProgressBar.x = CANVAS_WIDTH / 2 - (oSprite.width / 2);
        _oProgressBar.y = CANVAS_HEIGHT - 340;
        ...
        _oLoadingText.y = CANVAS_HEIGHT - 350;
