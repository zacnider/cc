function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        _pStartPosExit = {x: 660 , y: 550};
        _oButExit = new CGfxButton(_pStartPosExit.x, _pStartPosExit.y, oSprite, _oContainer);
        _oButExit.addEventListener(ON_MOUSE_UP, this.unload, this);

        _oMsgText = new createjs.Text(TEXT_CREDITS_DEVELOPED, "44px " + PRIMARY_FONT, "#d99b01");
        _oMsgText.textAlign = "center";
        _oMsgText.textBaseline = "alphabetic";
        _oMsgText.x = CANVAS_WIDTH/2;
        _oMsgText.y = CANVAS_HEIGHT/2 - 80;
        _oMsgOutline = new createjs.Text(TEXT_CREDITS_DEVELOPED, "44px " + PRIMARY_FONT, "#000");
        _oMsgOutline.textAlign = "center";
        _oMsgOutline.textBaseline = "alphabetic";
        _oMsgOutline.x = CANVAS_WIDTH/2;
        _oMsgOutline.y = CANVAS_HEIGHT/2 - 80;
        _oMsgOutline.outline = 3;
        _oContainer.addChild(_oMsgOutline);
        ...
        _oLink = new createjs.Text("www.codethislab.com", "38px " + PRIMARY_FONT, "#d99b01");
        _oLink.textAlign = "center";
        _oLink.textBaseline = "alphabetic";
        _oLink.x = CANVAS_WIDTH/2;
        _oLink.y = CANVAS_HEIGHT/2 + 120;
        _oLinkOutline = new createjs.Text("www.codethislab.com", "38px " + PRIMARY_FONT, "#000");
        _oLinkOutline.textAlign = "center";
        _oLinkOutline.textBaseline = "alphabetic";
        _oLinkOutline.x = CANVAS_WIDTH/2;
        _oLinkOutline.y = CANVAS_HEIGHT/2 + 120;
